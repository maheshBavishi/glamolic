      ...
      <AnimatePresence>
        {headerOpen && (
          <motion.div className={styles.mobileHeader} initial="closed" animate="open" exit="closed" variants={menuVariants}>
            <div className={styles.mobileHeaderAlign}>
              <Link href="/" aria-label="Home" className={styles.mobileLogo} onClick={() => setHeaderOpen(false)}>
                <img src={Logo} alt="Logo" />
              </Link>
              <button type="button" aria-label="Close menu" className={styles.mobileCloseButton} onClick={() => setHeaderOpen(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
            ...
            <div className={styles.mobileBody}>
              ...
              <motion.a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  setHeaderOpen(false);
                  router.push(user?.id ? "/history" : "/login");
                }}
              >
                History
              </motion.a>
            ...
            <motion.div variants={itemVariants} className={styles.mobileFooter}>
              {loading ? (
                ...
                <>
                  <Link href="/login" style={{ width: "100%" }} onClick={() => setHeaderOpen(false)}>
                    <button aria-label="Login" className={styles.light}>
                      Login
                    </button>
                  </Link>
                  <Link href="/signup" style={{ width: "100%" }} onClick={() => setHeaderOpen(false)}>
                    <button aria-label="Get Started" className={styles.fill}>
                      Get Started
                    </button>
                  </Link>
