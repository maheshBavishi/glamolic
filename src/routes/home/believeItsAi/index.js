  ...
  return (
    <div className={styles.believeItsAi}>
      <div className="container">
        <motion.div className={styles.box} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
          <div className={styles.grid}>
            <motion.div variants={slideInLeft}>
              <motion.div className={styles.imageBox} whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
                <img src={AiImage} alt="AiImage" />
              </motion.div>
            </motion.div>
            <motion.div variants={slideInRight}>
              <motion.div className={styles.content} variants={staggerContainer}>
                <motion.h3 variants={fadeInUp}>See The Difference - Real vs Glamolic AI</motion.h3>
                <motion.p variants={fadeInUp}>
                  When you apply a style to your photo, glamolic AI doesn't just overlay elements it intelligently generates them to produce high
                  quality, realistic images that blend seamlessly with your original photo for a natural, lifelike result.
                </motion.p>
