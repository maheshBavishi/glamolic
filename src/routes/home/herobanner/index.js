...
export default function Herobanner() {
  ...
  return (
    <motion.div className={styles.herobanner} initial="hidden" animate="visible" variants={containerVariants}>
        ...
        <div className="container">
          <div className={styles.grid}>
            <motion.div className={styles.griditems} variants={containerVariants}>
              ...
              <motion.h1 variants={leftItemVariants}>Create Studio-Quality Fashion Photos Without a Photoshoot</motion.h1>
            ...
            <motion.div className={styles.griditems} variants={rightItemVariants}>
              <div className={styles.rightAlignmentBox}>
                <motion.div variants={rightItemVariants}>
                  <motion.div className={styles.uploadBox} whileHover={{ y: -5 }} animate={floatingAnimation.animate}>
                    <div className={styles.uploadBoxText}>
                      <div className={styles.icon}>
                        <GalleryIcon />
                      </div>
                      <span>Just upload and apply! Explore trending styles and see yourself in a new light.</span>
                    </div>
