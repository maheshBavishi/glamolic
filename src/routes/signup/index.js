...
export default function Signup() {
    ...
    const validate = () => {
        ...
        if (!formData?.password || formData?.password?.trim() === "") {
            ...
            formIsValid = false;
            newErrors["password"] = "Password must contain at least 8 characters, including at least one uppercase letter, one lowercase letter, one digit, and one special character!";
        }
        setErrors(newErrors);
        return formIsValid;
    };
